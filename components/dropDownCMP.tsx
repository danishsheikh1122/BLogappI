  ...
  (
    ...
    const imageUrl = React.useMemo(() => {
      if (typeof value === 'string') {
        return value; // Use URL directly
      } else if (value) {
        return URL.createObjectURL(value); // Create URL for File object
      }
      return null;
    }, [value]);
    ...
    const {
      ...
      onDrop: (acceptedFiles: any) => {
        ...
        if (file) {
          void onChange?.(file); // Call onChange with the selected file
        }
      },
      ...dropzoneOptions,
    });
        ...
        >
          ...
          {imageUrl && !disabled && (
            <div
              ...
              onClick={(e) => {
                e.stopPropagation();
                void onChange?.(undefined); // Clear the file
              }}
            >
